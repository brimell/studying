    ...
    <div className="app-shell">
      <header className="top-nav sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
          <h1 className="text-lg sm:text-xl font-bold tracking-tight text-zinc-900">Settings</h1>
          <Link href="/" className="pill-btn">← Dashboard</Link>
        </div>
      </header>

      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-9">
